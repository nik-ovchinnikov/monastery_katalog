...
@Component({
  selector: 'app-add-churchItem-form',
  templateUrl: './add-churchItem-form.component.html',
  styleUrls: ['./add-churchItem-form.component.css']
})
export class AddChurchItemFormComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.typeService.urlParam = 'churchItem';
    this.placeService.urlParam = 'churchItem';
    ...
    this.myForm.get("publisher")?.valueChanges.subscribe((data) => {
      this.itemService.resultItem.publisher= data;
    });
    ...
    this.myForm.get("weight")?.valueChanges.subscribe((data) => {
      this.itemService.resultItem.weight= data;
    });

    this.myForm.get("size")?.valueChanges.subscribe((data) => {
      this.itemService.resultItem.size = data;
    });

    this.myForm.get("material")?.valueChanges.subscribe((data) => {
      this.itemService.resultItem.material = data;
    });
