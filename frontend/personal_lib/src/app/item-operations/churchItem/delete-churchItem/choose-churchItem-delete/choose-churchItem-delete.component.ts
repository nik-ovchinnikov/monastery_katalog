...
@Component({
  selector: 'app-choose-churchItem-delete',
  templateUrl: './choose-churchItem-delete.component.html',
  styleUrls: ['./choose-churchItem-delete.component.css']
})
export class ChooseChurchItemDeleteComponent implements OnInit {
