...
@Component({
  selector: 'app-churchItem-change-form',
  templateUrl: './churchItem-change-form.component.html',
  styleUrls: ['./churchItem-change-form.component.css']
})
export class ChurchItemChangeFormComponent implements OnInit {
  ...
  cleanForm() {
        ...
        this.itemService.itemToChange = new ChurchItem();
        // this.ngOnInit();
        // this.myForm.reset();
