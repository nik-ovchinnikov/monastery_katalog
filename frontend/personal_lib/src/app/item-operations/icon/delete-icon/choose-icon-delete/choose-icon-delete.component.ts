...
@Component({
  selector: 'app-choose-icon-delete',
  templateUrl: './choose-icon-delete.component.html',
  styleUrls: ['./choose-icon-delete.component.css']
})
export class ChooseIconDeleteComponent implements OnInit {
