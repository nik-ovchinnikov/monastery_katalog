...
export class FilterByNamePipe implements PipeTransform {
  transform(itemList: Icon[], itemFilterData: IconFilter) {
  ...
  sortFilteredArray(sortType: string, array: Icon[]): Icon[] {
  ...
  sortByLastChangeDate(array: Icon[]) {
    array = array.sort((a, b) => {
