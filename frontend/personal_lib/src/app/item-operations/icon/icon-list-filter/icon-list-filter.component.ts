...
@Component({
  selector: 'app-icon-list-filter',
  templateUrl: './icon-list-filter.component.html',
  styleUrls: ['./icon-list-filter.component.css']
})
export class IconListFilterComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    typeService.urlParam = 'icon';
    placeService.urlParam = 'icon';
  }
