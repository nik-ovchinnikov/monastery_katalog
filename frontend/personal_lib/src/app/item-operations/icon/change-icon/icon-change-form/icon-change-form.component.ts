...
@Component({
  selector: 'app-icon-change-form',
  templateUrl: './icon-change-form.component.html',
  styleUrls: ['./icon-change-form.component.css']
})
export class IconChangeFormComponent implements OnInit {
  ...
  resetChanges() {
    ...
    this.myForm.patchValue({
      ...
      author: this.itemService.itemToChange.author,
      publisher: this.itemService.itemToChange.publisher,
      seria: this.itemService.itemToChange.seria,
      weight: this.itemService.itemToChange.weight,
      size: this.itemService.itemToChange.size,
      material: this.itemService.itemToChange.material,
  ...
  cleanForm() {
        ...
        this.itemService.itemToChange = new Icon();
        // this.ngOnInit();
        // this.myForm.reset();
  ...
  formChangeSubscribe() {
    ...
    this.myForm.get("author")?.valueChanges.subscribe((data) => {
      this.itemService.changedItem.author= data;
    });
    ...
    this.myForm.get("publisher")?.valueChanges.subscribe((data) => {
      this.itemService.changedItem.publisher= data;
    });
    ...
    this.myForm.get("weight")?.valueChanges.subscribe((data) => {
      this.itemService.changedItem.weight= data;
    });

    this.myForm.get("size")?.valueChanges.subscribe((data) => {
      this.itemService.changedItem.size = data;
    });

    this.myForm.get("material")?.valueChanges.subscribe((data) => {
      this.itemService.changedItem.material = data;
    });
  ...
  createItemChanged() {
    ...
    this.itemService.changedItem.author = this.itemService.itemToChange.author;
    this.itemService.changedItem.publishYear = this.itemService.itemToChange.publishYear;
    this.itemService.changedItem.publisher = this.itemService.itemToChange.publisher;
    this.itemService.changedItem.seria = this.itemService.itemToChange.seria;
    this.itemService.changedItem.weight = this.itemService.itemToChange.weight;
    this.itemService.changedItem.size = this.itemService.itemToChange.size;
    this.itemService.changedItem.material = this.itemService.itemToChange.material;
