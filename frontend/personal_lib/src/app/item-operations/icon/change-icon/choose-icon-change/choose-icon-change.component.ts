...
@Component({
  selector: 'app-choose-icon-change',
  templateUrl: './choose-icon-change.component.html',
  styleUrls: ['./choose-icon-change.component.css']
})
export class ChooseIconChangeComponent implements OnInit {
  ...
  onChangeBtnClick(event: any) {
    ...
    this.router.navigateByUrl('/icon/change/change-form');
  }
