...
@Component({
  selector: 'app-choose-relic-change',
  templateUrl: './choose-relic-change.component.html',
  styleUrls: ['choose-relic-change.component.css']
})
export class ChooseRelicChangeComponent implements OnInit {
  ...
  onChangeBtnClick(event: any) {
    ...
    this.router.navigateByUrl('/relic/change/change-form');
  }
