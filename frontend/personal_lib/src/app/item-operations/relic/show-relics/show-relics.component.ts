...
@Component({
  selector: 'app-show-relics',
  templateUrl: './show-relics.component.html',
  styleUrls: ['./show-relics.component.css']
})
export class ShowRelicsComponent implements OnInit, OnDestroy {
