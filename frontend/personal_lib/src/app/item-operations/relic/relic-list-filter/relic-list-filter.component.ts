...
@Component({
  selector: 'app-relic-list-filter',
  templateUrl: './relic-list-filter.component.html',
  styleUrls: ['./relic-list-filter.component.css']
})
export class RelicListFilterComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    typeService.urlParam = 'relic';
    placeService.urlParam = 'relic';
  }
