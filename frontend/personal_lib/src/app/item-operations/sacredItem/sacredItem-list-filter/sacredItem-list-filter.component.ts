...
@Component({
  selector: 'app-sacredItem-list-filter',
  templateUrl: './sacredItem-list-filter.component.html',
  styleUrls: ['./sacredItem-list-filter.component.css']
})
export class SacredItemListFilterComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    typeService.urlParam = 'sacredItem';
    placeService.urlParam = 'sacredItem';
  }
