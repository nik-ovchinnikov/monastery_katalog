...
@Component({
  selector: 'app-choose-sacredItem-change',
  templateUrl: './choose-sacredItem-change.component.html',
  styleUrls: ['./choose-sacredItem-change.component.css']
})
export class ChooseSacredItemChangeComponent implements OnInit {
  ...
  onChangeBtnClick(event: any) {
    ...
    this.router.navigateByUrl('/sacredItem/change/change-form');
  }
