...
@Component({
  selector: 'app-sacredItem-change-form',
  templateUrl: './sacredItem-change-form.component.html',
  styleUrls: ['./sacredItem-change-form.component.css']
})
export class SacredItemChangeFormComponent implements OnInit {
  ...
  cleanForm() {
        ...
        this.itemService.itemToChange = new SacredItem();
        // this.ngOnInit();
        // this.myForm.reset();
