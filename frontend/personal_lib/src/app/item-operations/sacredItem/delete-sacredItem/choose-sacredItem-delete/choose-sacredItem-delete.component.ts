...
@Component({
  selector: 'app-choose-sacredItem-delete',
  templateUrl: './choose-sacredItem-delete.component.html',
  styleUrls: ['./choose-sacredItem-delete.component.css']
})
export class ChooseSacredItemDeleteComponent implements OnInit {
