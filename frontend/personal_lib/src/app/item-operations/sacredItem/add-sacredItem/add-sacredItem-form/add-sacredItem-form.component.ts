...
@Component({
  selector: 'app-add-sacredItem-form',
  templateUrl: './add-sacredItem-form.component.html',
  styleUrls: ['./add-sacredItem-form.component.css']
})
export class AddSacredItemFormComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.typeService.urlParam = 'sacredItem';
    this.placeService.urlParam = 'sacredItem';
