...
public class BookPlaceRest {
    ...
    public void addType(@RequestBody BookPlace bookPlace) {
        if(bookPlace.getSubPlaceList() != null) {
            for(BookSubPlace subtype: bookPlace.getSubPlaceList()) {
                subtype.setPlace(bookPlace);
            }
        }
    ...
    public void updatePlace(@RequestBody BookPlace updatedBookPlace) {
        if(updatedBookPlace.getSubPlaceList() != null) {
            for(BookSubPlace st: updatedBookPlace.getSubPlaceList()) {
                st.setPlace(updatedBookPlace);
            }
        }
