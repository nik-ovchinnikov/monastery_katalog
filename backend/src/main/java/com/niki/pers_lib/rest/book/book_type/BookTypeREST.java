...
public class BookTypeREST {
    ...
    public void addType(@RequestBody BookType bookType) {
        if(bookType.getSubTypeList() != null) {
            for(BookSubType subtype: bookType.getSubTypeList()) {
                subtype.setType(bookType);
            }
        }
...
//
    ...
    public void updateType(@RequestBody BookType updatedBookType) {
        if(updatedBookType.getSubTypeList() != null) {
            for(BookSubType st: updatedBookType.getSubTypeList()) {
                st.setType(updatedBookType);
            }
        }
