...
public class BookDao implements IBookDao{
    ...
    @Override
    public List<Book> findBySubType(BookSubType bookSubType) {
        return null;
    }
    ...
    @Override
    public List<Book> findByPlace(BookPlace bookPlace) {
        return null;
    }

    @Override
    public List<Book> findBySubPlace(BookSubPlace bookSubPlace) {
        return null;
    }
